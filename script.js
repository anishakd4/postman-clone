...
form.addEventListener("submit", (e) => {
  ...
  axios({
    ...
    // jsonResponseBody.textContent = prettyjson.render(response.data, options);
    jsonResponseBody.textContent = JSON.stringify(response.data, null, "\t");
    jsonRequestBody.textContent = JSON.stringify(jsonResponseBody);
